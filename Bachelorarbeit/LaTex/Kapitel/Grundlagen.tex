...
Wellenlängen von 0.75m bis 120m zum Einsatz (Tabelle 1).
...
Die Durchdringungstiefe hängt auch von der Dielektrizitätskonstante, also der Leitfähigkeit, der reflektierenden Oberfläche ab. Ist diese groß, reflektiert die Oberfläche stark und die 
...
einer sehr langen wirksamen Antenne. Angepasste Verfahren oder Mischformen können je Beobachtungsszenario zum Einsatz kommen \cite{tutorial_on_sar}. 
