...
Der Schwellwert kann mit unterschiedlichen verfahren aus dem Bild beziehungsweise seinem Histogramm abgeleitet werden.
...
Eine Programmierschnittstelle, kurz API für Application Programming Interface, ist eine Menge von Funktionen und Prozeduren die einem Programm erlauben Zugriff auf 
Funktionen einer anderen Anwendung zu gewähren \cite{geospatial_apis}.
...
sowie die Auffindbarkeit und Durchsuchbarkeit dieser. Ein weiterer Bereich widmet sich Standards rund um den betrieb von Sensornetzwerken sowie deren Schnittstellen. 
