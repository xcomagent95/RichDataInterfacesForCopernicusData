...
```
Wird der Job akzeptiert und bearbeitet werden zunächst Sentinel-1 Datensätze vor und nach dem Überschwemmungsereignis heruntergeladen, kalibriert und zugeschnitten.
![Pre](https://github.com/xcomagent95/RichDataInterfacesForCopernicusData/blob/main/example/pre.png?raw=true)
![Post](https://github.com/xcomagent95/RichDataInterfacesForCopernicusData/blob/main/example/post.png?raw=true)

Aus diesen beiden Radarbildern wird der normalized Difference Sigma-Naught Index berechnet. 
![NDSI](https://github.com/xcomagent95/RichDataInterfacesForCopernicusData/blob/main/example/ndsi.png?raw=true)

Aus diesem kann eine binäre Überflutungsmaske abgeleitet werden.
![Flood-Mask](https://github.com/xcomagent95/RichDataInterfacesForCopernicusData/blob/main/example/bin.png?raw=true)
